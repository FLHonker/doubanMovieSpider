...
class DoubanmoviePipeline(object):
    ...
    def __init__(self):
        ...
        # 设置excel标题栏内容
        headers = ['排名', '电影名称', '海报地址', '详情链接', '评分', '参评人数', '最新评论']
        # 设置excel标题栏字体为黑色加粗
    ...
    def process_item(self, item, spider):
        logging.info("--> Excel: write to excel file...")
        ...
        # 整理采集数据转化成一个list列表
        line = [item['rank'],item['title'],item['pic_url'],item['link'],item['rating'],item['participants'],item['quote']]
        # 循环追加写入excel文件
